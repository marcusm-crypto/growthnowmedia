...
2. Aspiring entrepreneurs who want to start their own aesthetic or wellness business (the Growth Now Advisor Program™ — the conversion emphasis on this site)

## Terminology (authoritative — use these exact terms in copy)
- **Audience umbrella**: "aesthetic and wellness businesses" (not "med spas and wellness clinics", not "wellness brands")
...
## Key proof points
- Worked with 500+ aesthetic and wellness locations across America
- Specialize in the aesthetic / wellness vertical (not generalists)
- The Growth Now Advisor Program™ is a consulting program for new business owners

## Pages to build (in priority order)
1. Home — hero, social proof, services overview, Advisor Program pitch, results, FAQ, CTA
